...
class _SpeciesDetailsState extends ConsumerState<SpeciesDetails> {
  ...
  Widget _mainContent(int totalAnalysisCount) {
    return Expanded(
      child: Container(
            ...
            Row(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Text('$totalAnalysisCount Kali',
                      style: GoogleFonts.poppins(
                          fontSize: 18,
                          color: Colors.grey
                      )),
  ...
  Widget build(BuildContext context) {
    ...
    final totalAnalysisCount = ref.watch(totalAnalysisCountProvider(widget.species.type));
                ...
                child: IntrinsicHeight(
                  child: Column(
                    children: [
                      ...
                      _mainContent(totalAnalysisCount.value ?? 0)
                    ],
                  )
                ),
              ),
