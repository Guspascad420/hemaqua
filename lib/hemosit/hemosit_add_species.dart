...
class HemositAddSpecies extends StatefulWidget {
  final int station;

  const HemositAddSpecies({super.key, required this.station});

  @override
  State<HemositAddSpecies> createState() => _HemositAddSpeciesState();
}

class _HemositAddSpeciesState extends State<HemositAddSpecies> {
  File? _imageFile;
  String? _imageName;
  int _imageSize = 0;
  bool _isError = false;
  ...
  Future<void> _uploadSpecies(BuildContext context) async {
    ...
    Map<String, dynamic> molluscaToBeAdded = {
      "name": localName.text,
    ...
    try {
      await service.addNewSpecies(molluscaToBeAdded, _imageFile!);
      setState(() {
        _isError = false;
      });
    } catch (e) {
                        ...
                        child: SingleChildScrollView(
                          child:  Column(
                            ...
                            children: [
                              ...
                              reusableTextField('Nama Latin', localName),
                              Container(
